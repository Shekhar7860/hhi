...
const Sponsoring = ({navigation}) => {return(<View style={{ flex: 1,padding : 30, alignItems: 'center', justifyContent: 'center' }}>
...
<TouchableOpacity style={styless.button} onPress={() => navigation.navigate('Products')}>
